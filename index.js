...
io.on("connection", (socket) => {
  ...
  // });
  socket.on("settingchange", (settings) => {
    io.to(socket.roomname).emit("settingchangeres", changeRoomSettings(socket.roomname, settings));
  });
